...
public class WebFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mURL == CONTACT) {
            mWebView.loadUrl("http://" + mApp.getServerHost() + ":" + mApp.getServerPort() + "/contact-orange-mobile.jsf");
        } else if (mURL == LEGAL) {
            mWebView.loadUrl("http://" + mApp.getServerHost() + ":" + mApp.getServerPort() + "/legal-orange-mobile.jsf");
        } else if (mURL == PRIVACY) {
            mWebView.loadUrl("http://" + mApp.getServerHost() + ":" + mApp.getServerPort() + "/privacy-orange-mobile.jsf");
        } else if (mURL == SPECIAL_OFFER) {
            mWebView.loadUrl("http://" + mApp.getServerHost() + ":" + mApp.getServerPort() + "/CreateSpecialOffers");
