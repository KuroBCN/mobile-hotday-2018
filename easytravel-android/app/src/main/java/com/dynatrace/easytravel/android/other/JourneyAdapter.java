...
public class JourneyAdapter extends RecyclerView.Adapter<JourneyAdapter.JourneyViewHolder> {
    ...
    public static class JourneyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.descriptionJourney)
        TextView mDescription;
        @BindView(R.id.nameJourney)
        TextView mName;
        @BindView(R.id.cardResult)
        CardView mCard;
        @BindView(R.id.pictureJourney)
        ImageView mPicture;
        @BindView(R.id.priceJourney)
        TextView mPrice;
        @BindView(R.id.fromJourney)
        TextView mFrom;
        @BindView(R.id.toJourney)
        TextView mTo;
